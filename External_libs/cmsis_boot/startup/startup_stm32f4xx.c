...
/* 
 * 2016-04-14 JI Filling stack with pattern at startup
 */
...
void (* const g_pfnVectors[])(void) =
{
  ...
  (void *)_StackTop,     /*!< The initial stack pointer         */
...
void Default_Reset_Handler(void)
{
   ...
   * TODO:  Write some more intelligent pattern
   *        Each byte with the value of the lsb of its address
   */
  __asm("  ldr     r0, =_StackBot\n"
        "  ldr     r1, =_StackTop\n"
        "  mov     r2, 0xFE\n"
        "  .thumb_func\n"
        "fill_loop:\n"
